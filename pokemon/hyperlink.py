...
def assign_hyperlink (df):
    ...
    for _, row in df.iterrows():
        ...
        if pd.notnull(row['Type 2']):
            ...
            type_2 = f"<a href='{type_2_url}' target='_blank'><img src='{type_2_url}' width='70'></a>" if type_2_url != 'https://storage.googleapis.com/pokemon_pngs/Pokemon%20PNG%202/None.png' else ""
